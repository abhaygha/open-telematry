...
const Navbar = () => {
    ...
    const {setShowSearch, getCartCount, updateCartCount} = useContext(ShopContext);
  ...
  return (
    <div className='flex items-center justify-between py-5 font-medium'>
        {/* <Link to='/'><img src={assets.logo} className='w-36' alt="E-cart" /></Link> */}
        {/* <Link to='/'><img src={assets.logo1} className='w-36 h-auto' alt="E-cart" /></Link> */}
        <Link to='/'><img src={assets.logo1} className='w-30  ' alt="E-cart" /></Link>
        ...
        <div className='flex items-center gap-6'>
            <img onClick={()=>seacrhClick()} src={assets.search_icon} className='w-5 cursor-pointer' alt="" />
